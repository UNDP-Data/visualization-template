                              ...
                              rows: [
                                {
                                  ...
                                  value: d.param1 ? `${xIndicatorMetaData?.LabelPrefix} ${d.param1} ${xIndicatorMetaData?.LabelSuffix}` : 'NA',
                                  type: 'color',
                                  year: d.year,
                                  color: '#E26B8D',
                                },
                                {
                                  ...
                                  value: d.param2 ? `${yIndicatorMetaData?.LabelPrefix} ${d.param2} ${yIndicatorMetaData?.LabelSuffix}` : 'NA',
                                  type: 'color',
                                  year: d.year,
                                  color: '#266291',
                                },
